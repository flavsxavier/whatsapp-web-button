...
jQuery(document).ready(function(a){a("#wwbSelect").change(function(){if(""!==a(this).val()){var e=[];e[0]=a(this).val(),e[1]=e[0].replace("(",""),e[2]=e[1].replace(")",""),e[3]=e[2].replace(" ",""),e[4]=e[3].replace("-",""),a("#wwb__modal .modal-content .modal-footer a").attr({href:"https://wa.me/55"+e[4],target:"_blank"})}else a("#wwb__modal .modal-content .modal-footer a").attr({href:"#!",target:"_self"})})});
