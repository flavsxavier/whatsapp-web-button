...
jQuery(document).ready(function(e){e("a #wwb__section.desktop img").tooltip(),e("#wwbSelect").change(function(){if(""!==e(this).val()){var a=[];a[0]=e(this).val(),a[1]=a[0].replace("(",""),a[2]=a[1].replace(")",""),a[3]=a[2].replace(" ",""),a[4]=a[3].replace("-",""),e("#wwbModal .modal-dialog .modal-content .modal-footer a").attr("href","https://wa.me/55"+a[4])}else e("#wwbModal .modal-dialog .modal-content .modal-footer a").attr("href","#")})});
//# sourceMappingURL=wwb.scripts.min.js.map
